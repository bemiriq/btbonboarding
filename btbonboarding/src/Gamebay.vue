          ...
          <b-col lg="7" style="background-color:#fafafa;height: 650px;">
            ...
            <div class="bv-example-row">
              ...
              <b-row>
                ...
                <b-col>
                      <b-col :class="{ red : sendToWishlistClicked10 }">
                        ...
                        <div>
                          <b-row style="border-style: outset; width: 95%; margin:auto; border-color:#17a2b8; border-width:thin;">
                            <b-col>
                              <draggable id="first" data-source="juju" :list="releasedPlayerList" class="list-group" draggable=".item" group="a" style="height: 440px;" @add="dragPlayerIn($event)" @change="dragPlayerOut($event)">

                                <div class="list-group-item item" v-for="(element, index) in releasedPlayerList" :key="index" v-show=" index % 2 == '0'" >
                                  <b-row>
                                    <b-col sm="0">
                            ...
                            <b-col>
                              <draggable id="first" data-source="juju" :list="releasedPlayerList" class="list-group" draggable=".item" group="a" style="height: 440px;" @add="dragPlayerIn($event)" @change="dragPlayerOut($event)">
                                ...
                                <b-row class="list-group-item item" v-for="(element, index) in releasedPlayerList" :key="index" v-show=" index % 2 != '0'">
                                  <b-row>
                                    <b-col sm="0" >
                        ...
                        <b-row>
                          ...
                          <div style="width: 41%; margin:auto;">
                            <b-row>
                              ...
                              <b-col>
                                <b-button block v-b-modal.modal-center variant="primary">Send to Waitlist</b-button>

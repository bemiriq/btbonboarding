	...
	<div id="rfidapp" style="min-width: 100%;min-height: 100vh;margin-top: -7%;">
		...
		<table style="width: auto; margin:auto;" v-if="teamName.length < '1'">
			<tr>
				...
				<td class="fontStyle">
					<p class="adjustTitle2 blink_me" v-if="activateError != '1' " style="font-size: 230px; margin-top: 1%;">{{suitUpZoneText}}</p>
				</td>

			</tr>
		</table>

		<table style="width: auto; margin-top:-3%; margin-left:4.5%;" v-if="teamName.length < '1'">
			<tr>
